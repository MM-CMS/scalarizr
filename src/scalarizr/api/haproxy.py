...
from scalarizr import exceptions, linux
...
from scalarizr.api.nginx import selinux_port
...
class HAProxyAPI(BehaviorAPI):
    ...
    def __init__(self, path=None):
        self.cfg = haproxy.HAProxyConfManager()
    ...
    def make_proxy(self, port, backend_port=None, backends=None, template=None,
        ...
        if linux.os.redhat_family and backend_port != port:
            selinux_port('add', backend_port)
